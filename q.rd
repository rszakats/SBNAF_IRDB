<resource schema="sbnaf">
    ...
    SBNAF public database of thermal infrared observations of small bodies in
    the solar system. Our database collects thermal emission measurements of
    small Solar Systems targets that are otherwise available in scattered
    sources  and  gives  a  complete  description  of  the  data,  with  all
    information  necessary  to  perform  direct  scientific  calculations  and
    without  the  need  to  access additional, external resources.
    See the details here: https://ird.konkoly.hu/</meta>
<meta name="copyright">
    We kindly request the authors of any communications and
    publications using these data to let us know about them and
    include minimal citation to the reference.
    <br/><br/>
<!--Acknowledgement: TBD<br/>-->
    Courtesy: Small Bodies Near And Far (SBNAF) is a science project funded by
    European Commission in HORIZON 2020 Framework Programme for Research and
    Innovation under Grant agreement No 687378.
    The operation of the database is supported by the Hungarian Research,
    Development and Innovation Office (grant no. K-125015), and by the Hungarian
    Academy of Sciences (EUHUNKPT/2018).
    This research made use of Astropy, (http://www.astropy.org) a
    community-developed core Python package for Astronomy
    <br/><br/>
    Reference: https://arxiv.org/abs/2001.01482<br/>
    <!--biblio reference-->
</meta>
        <meta name="creationDate">2019-10-18T00:00:00Z</meta>
        <meta name="subject">asteroids</meta>
        <meta name="subject">Solar system astronomy</meta>
        <meta name="creator.name">Robert Szakats</meta>
        <meta name="contact.name">Robert Szakats</meta>
        <meta name="contact.email">szakats.robert@csfk.mta.hu</meta>
        <meta name="contact.address">H-1121 Budapest, Konkoly Thege Miklos ut 15-17</meta>
        ...
        <meta name="publisher">Konkoly Observatory</meta>
        </meta>

<!-- METADATA COMPLETE -->

        <table id="epn_core" onDisk="true" adql="True" primary="granule_uid">
                <meta name="description">Our database collects thermal emission measurements of small Solar Systems targets that are otherwise available in scattered sources and gives a complete description of the data.</meta>
		<meta name="referenceURL">http://nadir.konkoly.hu:80/tableinfo/sbnaf.epn_core</meta>
...
-->
                        <column name="native_ID" tablehead="observation_IDs" type="text" ucd="meta.id"
...
-->
                        ...
                        description="Target’s  apparent  solar  elongation seen   from   the   observer   location   at   print-time."/>
<!--
...
<!-- -->
                        <column name="target_X_sun" tablehead="target_X_sun" type="double precision" ucd="pos.cartesian.x" unit="au"
                        ...
                        <column name="target_Y_sun" tablehead="target_Y_sun" type="double precision" ucd="pos.cartesian.y" unit="au"
                        ...
                        <column name="target_Z_sun" tablehead="target_Z_sun" type="double precision" ucd="pos.cartesian.z" unit="au"
                        description="Sun-centered Y Cartesian coordinate of the target body at observation mid-time, in the referenceframe defined in Archinal et al. (2011)."/>

                        <column name="target_X_observer" tablehead="target_X_observer" type="double precision" ucd="pos.cartesian.x" unit="au"
                        ...
                        <column name="target_Y_observer" tablehead="target_Y_observer" type="double precision" ucd="pos.cartesian.y" unit="au"
                        ...
                        <column name="target_Z_observer" tablehead="target_Z_observer" type="double precision" ucd="pos.cartesian.z" unit="au"
                        ...
                        <column name="observer_X_sun" tablehead="observer_X_sun" type="double precision" ucd="pos.cartesian.x" unit="au"
                        ...
                        <column name="observer_Y_sun" tablehead="observer_Y_sun" type="double precision" ucd="pos.cartesian.y" unit="au"
                        ...
                        <column name="observer_Z_sun" tablehead="observer_Z_sun" type="double precision" ucd="pos.cartesian.z" unit="au"
...
-->
                                <var key="native_ID" source ="observation_IDs" />
<!--
...
<!--
-->
                                <var key="target_X_sun" source ="target_X_sun" />
                                <var key="target_Y_sun" source ="target_Y_sun" />
                                <var key="target_Z_sun" source ="target_Z_sun" />
                                <var key="target_X_observer" source ="target_X_observer" />
                                <var key="target_Y_observer" source ="target_Y_observer" />
                                <var key="target_Z_observer" source ="target_Z_observer" />
                                <var key="observer_X_sun" source ="observer_X_sun" />
                                <var key="observer_Y_sun" source ="observer_Y_sun" />
                                <var key="observer_Z_sun" source ="observer_Z_sun" />
                                ...
                                <!-- Map mandatory parameters only -->
                                        ...
                                        <bind key="granule_uid">@targetname+'/'+@observation_start_time+'/'+@band_filter+'/'+str(@corrected_flux_err)+'/'+str(@inband_flux_error_Jy)</bind>
                                        <!-- not unique in the dataset, but this is OK for gid (target+instrument_host) -->
                                        <!--
                                        <bind key="granule_gid">@granule_uid</bind>
                                        -->
                                        <bind key="granule_gid">@targetname+@observatory_project+"_proc"</bind>
        ...
        <regSuite title="SBNAF regression test">
                <regTest title="SBNAF contains credible data">
                        <url parSet="TAP" QUERY="select * from sbnaf.epn_core
                                        WHERE granule_uid='Dione/2454128.75793/S9W/74.0/0.064'"
                                >/tap/sync</url>
                        <code>
